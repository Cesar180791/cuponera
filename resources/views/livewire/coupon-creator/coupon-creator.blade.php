            ...
            @error('image') <span class="text-danger er">{{ $message }}</span> @enderror
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-4">
                            ...
                            <input wire:model="fechaInicio" type="text"
                                class="form-control flatpickr" placeholder="Click para seleccionar">
                ...
                <div class="modal-footer">
                    <button type="button" wire:click.prevent="Store()"
                        class="btn btn-success btn-rounded">Crear</button>
                </div>
            </div>
        </div>
...
<div class="container">
    ...
    <div class="profile-card-4 text-center">
            ...
            @if ($image)
          <img style="height: 300; width: 400px;" src="{{$image->temporaryUrl()}}" class="img img-responsive">
    @endif
        ...
        <div class="profile-content">
            <div class="profile-name"><h3>{{$titulo}}</h3>
            ...
            <div class="profile-description">{{$descripcion}}</div>
                ...
                <div class="col-sm-4">
                    <div class="profile-overview">
                        <p>PRECIO REGULAR</p>
                        <h4>$ {{$precioRegular}}</h4></div>
                </div>
                <div class="col-sm-4">
                    <div class="profile-overview">
                        <p>PROMOCION</p>
                        <h4>$ {{$PrecioOferta}}</h4></div>
                </div>
                   <div class="col-sm-4">
                    <div class="profile-overview">
                        <p>CANTIDAD</p>
                        <h4>{{$cantidadCupon}}</h4></div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="profile-overview">
                        ...
                        <h4>{{$fechaFinal}}</h4></div>
                </div>
                <div class="col-sm-6">
                    <div class="profile-overview">
                        <p>FECHA LIMITE DE CANJE</p>
                        <h4>{{$fechaLimiteCanje}}</h4></div>
                </div>
            </div>
                 <div class="row">
                <div class="col-sm-12">
                    <button type="button" wire:click.prevent="Store()"
                        class="btn btn-primary">Ver mas fertas de esta empresa</button>
                </div>
                <div class="col-sm-12">
                    <div class="profile-overview">
                        <button type="button" wire:click.prevent="Store()"
